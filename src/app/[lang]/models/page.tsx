          ...
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-4">
            <div>
              ...
              <p className="text-zinc-600 dark:text-gray-400 text-sm mt-3">
                {carsData.length} {t.page_subtitle}
              </p>
            </div>
        ...
        <AnimatePresence mode="wait">
          ...
          >
            {filtered.map((car, i) => {
              ...
              const carPower = carDict.specs?.power || car.specs.power
                ...
                >
                  ...
                  <div className="p-5 flex flex-col flex-1">
                    <div className="mb-3">
                      ...
                      <p className="text-xs text-zinc-500 dark:text-gray-500">{carSubtitle}</p>
                    </div>
                  ...
                  <div className="mt-auto flex items-center justify-between gap-3">
                    <div>
                      ...
                      <p className="text-base font-bold text-zinc-950 dark:text-white leading-none">
                        {car.price}
                        <span className="text-xs font-normal text-zinc-500 dark:text-gray-400 ml-1">{t.currency}</span>
                      </p>
                    </div>
                    <LangLink
                      href={`/models/${car.id}`}
