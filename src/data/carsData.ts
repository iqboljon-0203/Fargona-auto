...
export const carsData: Car[] = [
  ...
  // ═══════════════════ SEDAN ═══════════════════
  {
    ...
    featured: true,
    images: [
      '/cars/onix/onix-ext-uz.jpg',
      '/cars/onix/onix_uz.jpg',
      '/cars/onix/main-int.jpg',
      '/cars/onix/download.png',
    ],
    specs: {
    ...
    colors: [
      { name: 'Oq', hex: '#FFFFFF', image: '/cars/onix/6.png' },
      { name: 'Qora', hex: '#000000', image: '/cars/onix/2 (1).png' },
      { name: 'Qizil', hex: '#CC0000', image: '/cars/onix/3.png' },
      { name: "Ko'k", hex: '#1A3A5C', image: '/cars/onix/4.png' },
      { name: 'Kumush', hex: '#C0C0C0', image: '/cars/onix/1 (2).png' },
      { name: 'Kulrang', hex: '#888888', image: '/cars/onix/5.png' },
    ],
    safetyRating: 4,
  },
  {
    ...
    category: 'Sedan',
    images: [
      '/cars/cobalt-mcm/cobalt-uz.webp',
      '/cars/cobalt-mcm/1 (2).jpg',
      '/cars/cobalt-mcm/1 (1).jpg',
    ],
    specs: {
      engine: '1.5L',
      power: '106 ot kuchi',
    ...
    colors: [
      { name: 'Oq', hex: '#FFFFFF', image: '/cars/cobalt-mcm/w1.png' },
      { name: 'Qora', hex: '#1A1A1A', image: '/cars/cobalt-mcm/w8.png' },
      { name: 'Kumush', hex: '#C0C0C0', image: '/cars/cobalt-mcm/w11.png' },
      { name: 'Asfalt', hex: '#555555', image: '/cars/cobalt-mcm/w3.png' },
      { name: 'Qizil', hex: '#8B0000', image: '/cars/cobalt-mcm/w2.png' },
      { name: "Ko'k", hex: '#1A3A5C', image: '/cars/cobalt-mcm/w9.png' },
    ],
    safetyRating: 4,
  },
  {
    ...
    category: 'Sedan',
    images: [
      '/cars/cobalt/index.jpg',
      '/cars/cobalt/1.jpg',
      '/cars/cobalt/cobalt-uz.webp',
    ],
    specs: {
      engine: '1.5L',
      power: '106 ot kuchi',
    ...
    colors: [
      { name: 'Oq', hex: '#FFFFFF', image: '/cars/cobalt/1 (1).png' },
      { name: 'Kumush', hex: '#C0C0C0', image: '/cars/cobalt/7.png' },
      { name: 'Qora', hex: '#1A1A1A', image: '/cars/cobalt/7.png' },
      { name: 'Qizil', hex: '#8B0000', image: '/cars/cobalt/3.png' },
      { name: 'Bej', hex: '#F5F5DC', image: '/cars/cobalt/4.png' },
      { name: "Ko'k", hex: '#1A3A5C', image: '/cars/cobalt/9.png' },
    ],
    safetyRating: 4,
  },
  {
    ...
    category: 'Sedan',
    images: [
      '/cars/malibu-xl/malibu-uz.webp',
      '/cars/malibu-xl/one.jpg',
      '/cars/malibu-xl/5.jpg',
      '/cars/malibu-xl/DSCF5334.jpg',
    ],
    specs: {
      engine: '2.0L Turbo',
      power: '236 ot kuchi',
    ...
    colors: [
      { name: 'Oq', hex: '#FFFFFF', image: '/cars/malibu-xl/GAZ.png' },
      { name: 'Qora', hex: '#1A1A1A', image: '/cars/malibu-xl/GB8.png' },
      { name: 'Kumush', hex: '#C0C0C0', image: '/cars/malibu-xl/GZA.png' },
      { name: 'To\'q kulrang', hex: '#4A4A4A', image: '/cars/malibu-xl/G59.png' },
      { name: 'Marvarid Oq', hex: '#F0F0F0', image: '/cars/malibu-xl/GE8.png' },
      { name: "Ko'k", hex: '#1B3A6B', image: '/cars/malibu-xl/GPI.png' },
    ],
    safetyRating: 5,
  },
  ...
  // ═══════════════════ LCV ═══════════════════
  {
    ...
    category: 'LCV',
    images: [
      '/cars/labo/labo-uz.webp',
      '/cars/labo/gallery01.jpg',
      '/cars/labo/1.jpg',
    ],
    specs: {
      engine: '0.8L',
    ...
    colors: [
      { name: 'Oq', hex: '#FFFFFF', image: '/cars/labo/01.png' },
      { name: 'To\'q kulrang', hex: '#4A4A4A', image: '/cars/labo/04.png' },
      { name: 'Ko\'k', hex: '#1E90FF', image: '/cars/labo/05.png' },
      { name: 'Yashil', hex: '#008080', image: '/cars/labo/03.png' },
    ],
    safetyRating: 3,
  },
  {
    ...
    colors: [
      { name: 'Oq', hex: '#FFFFFF', image: '/cars/damas/01.png' },
      { name: 'Van', hex: '#F5F5F5', image: '/cars/damas/02.png' },
    ],
    safetyRating: 3,
  },
  {
    ...
    category: 'LCV',
    images: [
      '/cars/damas-move-max/hero-1.jpg',
      '/cars/damas-move-max/exterior-damas.jpg',
      '/cars/damas-move-max/tech1.jpg',
    ],
    specs: {
      engine: '1.2L',
      power: '84 ot kuchi',
    ...
    colors: [
      { name: 'Bej', hex: '#F5F5DC', image: '/cars/damas-move-max/20CHN457000.png' },
      { name: 'Oq', hex: '#FFFFFF', image: '/cars/damas-move-max/20CHN457001.png' },
      { name: 'Kumush', hex: '#C0C0C0', image: '/cars/damas-move-max/20CHN457002.png' },
    ],
    safetyRating: 4,
  },
]
